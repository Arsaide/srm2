...
const RenderFunc = () => {
    ...
    return (
        <div>
            ...
            <h3>Методи</h3>
            <div className={'cnt'}>
                <button onClick={() => setActiveFunc('FirstLabM1')}>Половинного ділення</button>
                <button onClick={() => setActiveFunc('FirstLabM2')}>Хорд</button>
                <button onClick={() => setActiveFunc('FirstLabM3')}>Ньютона</button>
                <button onClick={() => setActiveFunc('FirstLabM4')}>Простої ітерації</button>
            </div>
